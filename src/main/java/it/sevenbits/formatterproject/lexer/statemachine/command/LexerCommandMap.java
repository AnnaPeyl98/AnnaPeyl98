package it.sevenbits.formatterproject.lexer.statemachine.command;
...
import it.sevenbits.formatterproject.lexer.statemachine.command.implementation.SetToTokenCommand;
