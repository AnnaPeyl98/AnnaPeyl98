package it.sevenbits.formatterproject.lexer.implementation.statemachine.state.implementation;

import it.sevenbits.formatterproject.containers.Pair;
import it.sevenbits.formatterproject.lexer.implementation.statemachine.state.ILexerStateMap;
